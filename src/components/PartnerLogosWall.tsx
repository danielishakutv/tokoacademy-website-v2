    ...
    <section className="section-padding bg-surface">
      <div className="section-container">
        <div className="mb-10 max-w-3xl md:mb-12 reveal">
          ...
          <h2 className="mt-3">Trusted by Institutional Networks</h2>
          ...
          {categoryOrder.map((category) => {
            ...
            return (
              <div key={category} className="reveal">
                ...
                {/* Logo Grid. The tiles stay white in both themes — these are
                    other people's marks, mostly dark artwork on transparency,
                    and a dark tile would swallow half of them. */}
                ...
                <p className="mb-8 text-xs italic text-ink-subtle md:mb-10">
